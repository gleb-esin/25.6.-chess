public class ChessBoard {
    boolean castling0 = false;
    boolean castling7 = false;
    ...
    public boolean castling0() {
        ...
        if (nowPlayer.equals("White")) {
            //if king or rook cells is empty the castling is impossible
            if (board[0][0] == null || board[0][4] == null) return false;
            // check that King and Rook
            if (board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") &&
                    //there is no obstacle pieces for castling
                    board[0][1] == null && board[0][2] == null && board[0][3] == null) {
                // king and rook is never moved
